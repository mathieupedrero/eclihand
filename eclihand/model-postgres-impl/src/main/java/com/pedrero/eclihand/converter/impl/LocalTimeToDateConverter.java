...
public class LocalTimeToDateConverter extends DozerConverter<LocalTime, Date> {

	public LocalTimeToDateConverter(Class<LocalTime> prototypeA, Class<Date> prototypeB) {
