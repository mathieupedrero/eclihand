...
CONSTRAINT FK_PER__OBJ FOREIGN KEY (ID) REFERENCES OBJ_OBJECT (ID)
);
...
CONSTRAINT FK_PLA__OBJ FOREIGN KEY (ID) REFERENCES OBJ_OBJECT (ID)
);
...
CONSTRAINT FK_TEA__OBJ FOREIGN KEY (ID) REFERENCES OBJ_OBJECT (ID)
);
