...
INSERT INTO USR_USER VALUES (1,'admin',encode(digest('admin', 'sha1'), 'hex'), 'ADMIN');
INSERT INTO USR_USER VALUES (16,'invite',encode(digest('invite', 'sha1'), 'hex'), 'GUEST');
...
ALTER SEQUENCE OBJ_OBJECT_ID_SEQ RESTART WITH 16;
